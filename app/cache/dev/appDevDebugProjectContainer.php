...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Tp0', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\CRCtpBundle\\Entity')));
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\CRC\\HelloBundle\\Resources\\config\\doctrine') => 'CRC\\HelloBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $e->addDriver($b, 'AppBundle\\Entity');
        $e->addDriver($b, 'CRCtpBundle\\Entity');
        $e->addDriver($c, 'FOS\\UserBundle\\Entity');
        $e->addDriver($d, 'CRC\\HelloBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'CRCHelloBundle' => 'CRC\\HelloBundle\\Entity', 'CRCtpBundle' => 'CRCtpBundle\\Entity'));
        ...
        $f->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(NULL));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CRC\\HelloBundle/Resources/views'), 'CRCHello');
        $instance->addPath(($this->targetDirs[3].'\\src\\CRCtpBundle/Resources/views'), 'CRCtp');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CRCHelloBundle' => 'CRC\\HelloBundle\\CRCHelloBundle',
                'CRCtpBundle' => 'CRCtpBundle\\CRCtpBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'CRCHelloBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CRC\\HelloBundle'),
                    'namespace' => 'CRC\\HelloBundle',
                ),
                'CRCtpBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\CRCtpBundle'),
